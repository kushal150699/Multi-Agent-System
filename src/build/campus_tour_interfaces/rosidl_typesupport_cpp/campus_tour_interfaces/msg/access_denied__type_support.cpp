...
static const _AccessDenied_type_support_symbol_names_t _AccessDenied_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, campus_tour_interfaces, msg, AccessDenied)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, campus_tour_interfaces, msg, AccessDenied)),
  }
};
...
{
  return &::campus_tour_interfaces::msg::rosidl_typesupport_cpp::AccessDenied_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, campus_tour_interfaces, msg, AccessDenied)() {
  return get_message_type_support_handle<campus_tour_interfaces::msg::AccessDenied>();
}
