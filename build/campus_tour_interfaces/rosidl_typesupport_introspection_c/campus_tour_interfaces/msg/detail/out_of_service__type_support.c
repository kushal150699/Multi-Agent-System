...
static rosidl_typesupport_introspection_c__MessageMember campus_tour_interfaces__msg__OutOfService__rosidl_typesupport_introspection_c__OutOfService_message_member_array[2] = {
  {
    "bi_id",  // name
    ...
    offsetof(campus_tour_interfaces__msg__OutOfService, bi_id),  // bytes offset in struct
    NULL,  // default value
